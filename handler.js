...
require('./config.js')
'use strict';
const { WAConnection, MessageType, Mimetype, GroupSettingChange, generateWAMessageFromContent, prepareWAMessageMedia, proto } = require('@adiwajshing/baileys')
...
module.exports = { 
     async chatUpdate(xcaa, chat) {
        try {
           ...
           if (!xcaa.public && !m.key.fromMe && m.mtype === 'notify') return
           ...
           if (!xcaa.public && !isOwner && !m.key.fromMe) return
