...
`
              ...
              let prep = await conn.toMSG(imgB, 'imageMessage')
         ...
         case /^owner$/i.test(command): {
             ...
             conn.sendMessage(from, { displayName: listOwner.length + ' kontak', contacts: listOwner }, 'contactsArrayMessage', { quoted: ftroli })
             break
         }
